################################################################################
# Script: Step5_ASD_addLoop.R
# Purpose: Add Hi-C loop evidence and gene genomic positions to ASD-associated
#          enhancer-gene pairs.
# Inputs : 02.sig_enhancerTPM_geneTPM_ASDgene_mus.txt
#          03.mus_8w_loops_PE_pairs.txt
#          03.mus_e12.5_loops_PE_pairs.txt
#          Mus_musculus.GRCm39.113.chr.gtf
# Outputs: 03.sig_enhancerTPM_geneTPM_ASDgene_mus_Loop.txt/csv
#          04.sig_enhancerTPM_geneTPM_ASDgene_mus_GenePos.txt/csv
################################################################################
...
# 读取 sig 文件
sig <- read.table("05.ASDGene_file/02.sig_enhancerTPM_geneTPM_ASDgene_mus.txt", 
...
# 输出结果
# -------------------------
write.table(sig, "03.sig_enhancerTPM_geneTPM_ASDgene_mus_Loop.txt", 
            sep = "\t", quote = FALSE, row.names = FALSE)

write.table(sig, "03.sig_enhancerTPM_geneTPM_ASDgene_mus_Loop.csv", 
            sep = ",", quote = FALSE, row.names = FALSE)
...
# 1. 读入 sig 文件
sig <- read.table("03.sig_enhancerTPM_geneTPM_ASDgene_mus_Loop.txt",
...
# 5. 输出结果
write.table(sig_final, "04.sig_enhancerTPM_geneTPM_ASDgene_mus_GenePos.txt",
            sep = "\t", quote = FALSE, row.names = FALSE)

write.table(sig_final, "04.sig_enhancerTPM_geneTPM_ASDgene_mus_GenePos.csv",
            sep = ",", quote = FALSE, row.names = FALSE)
